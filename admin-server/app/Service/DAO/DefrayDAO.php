...
class DefrayDAO extends Base
{
    ...
    {
        return Defray::query()->where('id', $id)->update($data);
    }
     public function updateByOrderNo(string $order_no, array $data)
    {
        return Defray::query()->where('order_no', $order_no)->update($data);
    }
    
    public function delByOrderNo(string $order_no)
    {
        return Defray::query()->where('order_no', $order_no)->delete();
    }
}