...
//            $spreadsheet->getActiveSheet()->getColumnDimension('E')->setWidth(50);
            ...
            go(function () use ($spreadsheet) {
                //查询数据
                $rows = $this->container->get(MemberDAO::class)->getExportUsers()->toArray()['data'];
                //遍历数据
        ...
        try {
            ...
            go(function () use ($spreadsheet, $status_arr) {
                ...
                foreach ($rows as $i => $data)
                {
                    ...
                    $spreadsheet->getActiveSheet()->setCellValue('D'.($i+2), $data['exchange_rate']);
        ...
        try {
            ...
            go(function () use ($spreadsheet, $status_arr) {
                ...
                foreach ($rows as $i => $data)
                {
                    ...
                    $spreadsheet->getActiveSheet()->setCellValue('G'.($i+2), $data['exchange_rate']);
        ...
        try {
            ...
            go(function () use ($spreadsheet, $status_arr) {
                ...
                foreach ($rows as $i => $data)
                {
                    ...
                    $spreadsheet->getActiveSheet()->setCellValue('E'.($i+2), $data['exchange_rate']);
